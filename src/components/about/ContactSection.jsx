        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-4">
              <a href="mailto:shaunahasan.ar@gmail.com" 
                ...
                <span>shaunahasan.ar@gmail.com</span>
              </a>
          ...
          >
            ...
            <div className="flex gap-6">
              <a href="https://github.com/shaun-ar" target="_blank" rel="noopener noreferrer"
                className="text-3xl text-gray-600 dark:text-gray-300 hover:text-primary-500 dark:hover:text-primary-400">
                <FaGithub />
              </a>
              <a href="https://www.linkedin.com/in/shaun-ar" target="_blank" rel="noopener noreferrer"
                className="text-3xl text-gray-600 dark:text-gray-300 hover:text-primary-500 dark:hover:text-primary-400">
                <FaLinkedin />
              </a>
            </div>
